    ...
    <AuroraBackground className="pb-24 text-white">
      ...
      <section className="relative pt-24 md:pt-20 pb-32 md:pb-40 overflow-hidden w-full">
        <div className="section-shell relative z-10 flex flex-col items-center text-center">
          ...
          {/* Buttons */}
          <div className="mt-8 md:mt-10 flex flex-col gap-3 w-full max-w-md mx-auto px-4 lg:flex-row lg:max-w-none lg:justify-center">
            <Link
              href={appStore}
              className="group flex h-14 items-center justify-center gap-3 rounded-xl bg-white px-6 text-slate-950 shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all hover:bg-slate-50 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-[1.02] active:scale-95"
            >
              ...
              <span className="text-sm font-bold whitespace-nowrap text-black">Download on App Store</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm font-bold whitespace-nowrap text-black">Get it on Google Play</span>
            </Link>
            ...
            <Link
              ...
              className="group flex h-14 items-center justify-center gap-3 rounded-xl bg-white px-6 text-slate-950 shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all hover:bg-slate-50 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-[1.02] active:scale-95"
            >
              <MonitorPlay className="h-5 w-5 fill-black stroke-black flex-shrink-0" />
              <span className="text-sm font-bold whitespace-nowrap text-black">Try on Web</span>
            </Link>
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-emerald-400/15 via-cyan-400/10 to-indigo-400/10 p-10">
          ...
          <div className="relative grid gap-6 md:grid-cols-[1.2fr,0.8fr] md:items-center">
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3 w-full max-w-md lg:flex-row lg:max-w-none">
                <Link
                  href={appStore}
                  className="group flex h-14 items-center justify-center gap-3 rounded-xl bg-white px-6 text-slate-950 shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all hover:bg-slate-50 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-[1.02] active:scale-95"
                >
